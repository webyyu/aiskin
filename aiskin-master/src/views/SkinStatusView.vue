  ...
  <div class="skin-status-container">
    ...
    <div class="main-content">
      ...
      <div v-if="hasHistoryResults && !showResults" class="history-section">
        <!-- Weather Card - 在历史结果页面也显示天气 -->
        <WeatherCard @weather-updated="onWeatherUpdated" />
...
import WeatherCard from '@/components/skin-analysis/WeatherCard.vue'
...
export default {
  ...
  methods: {
    ...
    onWeatherUpdated(weatherData) {
      console.log('🌤️ 天气信息已更新:', weatherData);
      // 这里可以保存天气数据到本地存储或者发送到后端
